...
SECRET_KEY = '#_w8%1q66x1zc8!@g4yb(@es1_icy+ttaftm-_4*8yppio!+t7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# python manage.py runserver 0.0.0.0:8000
# 这是改变了这台机器监听的IP地址，会让Django监听所有网络接口和IP地址，因此也就能让其他机器连接到这台机器了
ALLOWED_HOSTS = ['192.168.20.56','127.0.0.1','localhost'] # 配置其他机器可通过这个IP访问，默认只能通过本机访问
